        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header border-0 px-0">
                <h4 class="card-subtitle text-center pt-2">
                    <span><strong>Association Images</strong></span>
                </h4>  
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-2 mb-2">
                                ...
                                <div class="mt-2">
                                    <a class="btn btn-outline-danger float-right" href="{{ url('delete-association-images/'.$item->id) }}">Delete</a>
                                </div>
                            </div>
                            @endforeach
                        </div>
...
<div class="modal fade" id="uploadImageModal" tabindex="-1" role="dialog" aria-labelledby="uploadImageModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <form id="bannerSectionForm" method="POST" action="{{ route('upload-association-images') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
