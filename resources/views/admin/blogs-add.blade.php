    ...
    <div class="col-md-8 col-8 box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 m-0">
            ...
            <div class="card-content">
                ...
                <form id="bannerSectionForm" method="POST" action="{{ route('save-blogs') }}" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="form-group">
                        <input id="title" type="text" class="form-control" maxlength="100" value="{{ old('title') }}" placeholder="Blog Title" name="title" required>              
                    </div>
