    ...
    <div class="col-md-8 col-8 box-shadow-2 p-0">
        <div class="card border-grey border-lighten-3 m-0">
            ...
            <div class="card-content">  
                    ...
                    <div class="card-body">
                        <div class="row">
                            @foreach ($clinicalImages as $key => $item) 
                            <div class="col-2 mb-2">
                                <img class="w-100" src="{{ asset('./'.$item->image_path) }}" alt="Image">
                                <div class="mt-2">
                                    <a class="btn btn-outline-danger float-right" href="{{ url('delete-clinical-images/'.$item->id) }}">Delete</a>
                                </div>
                            </div>
                            @endforeach
                        </div>
...
<div class="modal fade" id="uploadImageModal" tabindex="-1" role="dialog" aria-labelledby="uploadImageModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <form id="bannerSectionForm" method="POST" action="{{ route('upload-clinical-images') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
