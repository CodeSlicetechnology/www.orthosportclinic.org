        ...
        <div class="card border-grey border-lighten-3 m-0">
            <div class="card-header border-0">
                <h4 class="card-subtitle text-center pt-2">
                    <span><strong>Update About Dr.Alva</strong></span>
                </h4>                   
            </div>         
            ...
            <div class="card-content">
                ...
                <form id="bannerSectionForm" method="POST" action="{{ route('update-landing-about') }}" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        <textarea id="landing_desc" class="form-control" name="landing_desc" required>{{ $aboutDoctor->landing_desc }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <input type="hidden" name="oldImagePath1" value="{{ asset('./'.$aboutDoctor->doctorImages[0]->image_path) }}">
                        <img src="{{ asset('./'.$aboutDoctor->doctorImages[0]->image_path) }}" alt="Image" style="width: 100px;">              
                    </div>
