...
<head>    
    ...
    <link rel="stylesheet" href="{{ asset('website/css/bootstrap.min.css?v=1.2') }}">
    ...
    <link rel="stylesheet" href="{{ asset('website/css/style.css?v=1.4') }}">
    <link rel="stylesheet" href="{{ asset('website/css/responsive.css?v=1.4') }}">
