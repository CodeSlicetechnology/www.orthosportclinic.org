                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="banner-text">
                                <h1 class="wow fadeInUp font-weight-normal mb-2" data-wow-delay=".4s">World class Orthopaedic care</h1>
                                <h3 class="wow fadeInUp font-weight-normal mb-2 text-warning" data-wow-delay=".6s">Patient safety is our top priority.</h3>
                                <p class="wow fadeInUp mt-3 mb-2 text-secondary font-10pt" data-wow-delay=".8s">Video consultations now open!</p>
                        ...
                        <div class="row pb-2">                            
                            <div class="col-sm-12 col-md-2 col-lg-2">
                                <div class="assessments-img pb-3">
                                    <img class="width-100 box-shadow" src="{{ asset('website/img/avinash-color.jpg') }}" alt="Image">
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-10 col-lg-10">
                                <h4 class="font-weight-normal">Dr. Avinash Alva</h4>
